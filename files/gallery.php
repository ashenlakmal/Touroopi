...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
 ...
 <nav class="max-h-20 navbar navbar-expand-lg " style="background-color: #dbf2e1;" id="navbar">
         ...
         <div class=" navbar-collapse justify-content-center" id="nav1" >
            <ul class="navbar-nav mx-auto">
               ...
               <li class="nav-item">
                  <a href="other/sign up.html" class="px-3 py-2 btn btn-success ms-4" role="button">Sign Up</a>
               </li>
               <li class="nav-item">
                  <a href="other/login.html" class="px-4 py-2 btn btn-success ms-4 !important" role="button">Login</a>
               </li>
            </ul>
         </div>
      </nav>
      ...
      <div class="mx-auto">
            ...
            <a type="button" class="btn btn-success align-s" role="button" href="other/login.html">
               Post a Gallery</a>
      ...
      <?php require_once("other/connect.php"); ?>
      <?php 
      ...
      if ($result) {
         ...
         while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<div class=" card-deck overflow-hidden transition-all duration-300 transform bg-white rounded-md shadow-md card hover:scale-105">
                     ' . $map . '
                     <div class="card-body">
                        <h3 class="card-title"><b>' . $title . '</b></h3>
                        <p class="card-text">' . $sample . '</p>
                        <a data-toggle="modal" data-target="#modal' . $id . '" class="mt-2 btn btn-success">Go-to Content</a>
                     </div>
                  ...
                  <div class="mx-auto">
                     <div class="modal fade" id="modal' . $id . '" tabindex="-1" role="dialog" aria-labelledby="modalTitle' . $id . '" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                 <div class="modal-header">
                                 '.$map.'
                                    <h4 class="modal-title" id="modalTitle' . $id . '"><strong>' . $title . '</strong></h4>
                                 </div>
                                 <div class="modal-body">
                                    ...
                                    <a href="other/login.html" type="submit" name="submit" class="btn btn-success">Sign-in to response here</a>
...
<!-- Button trigger modal -->
      ...
      <div class="mx-auto">
         <div class="modal fade" id="maplink" tabindex="-1" role="dialog" aria-labelledby="cookiesTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
               <div class="modal-content">
                  <div class="modal-header">
